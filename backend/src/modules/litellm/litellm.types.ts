/**
 * LiteLLM Module — Type Definitions
 *
 * Pure type definitions for LiteLLM API request/response shapes,
 * provider/model records, metrics, and sync entities.
 * No runtime code — only `type` and `interface` declarations.
 */

// ============================================================
// LITELLM PROXY RESPONSE TYPES
// ============================================================
