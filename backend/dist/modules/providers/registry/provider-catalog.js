...
exports.getProviderBySlug = getProviderBySlug;
exports.getProviderByName = getProviderByName;
exports.listProviderSlugs = listProviderSlugs;
...
function getProviderBySlug(slug) {
    return exports.PROVIDER_CATALOG.find((p) => p.slug === slug);
}
function getProviderByName(name) {
    return exports.PROVIDER_CATALOG.find((p) => p.name === name);
}
function listProviderSlugs() {
    return exports.PROVIDER_CATALOG.map((p) => p.slug);
}
