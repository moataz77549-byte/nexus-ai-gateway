...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "List audit logs (paginated, filterable, sortable, searchable)" }),
    __param(0, (0, common_1.Query)(new zod_validation_pipe_1.ZodValidationPipe(audit_log_dto_1.listAuditLogsQuerySchema))),
